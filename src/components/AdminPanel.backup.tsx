    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="px-4 py-6 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="flex items-end">
                  <Button onClick={assignUserRole} className="w-full">
            ...
            <CardContent>
              {users.length === 0 ? (
                ...
                <div className="space-y-4">
                  {users.map(user => (
                    <div key={user.id} className="flex justify-between items-start p-4 border rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <TabsContent value="departments" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="userForDept">Pilih Pengguna</Label>
                ...
                <div>
                  <Label htmlFor="deptForOwner">Pilih Departemen</Label>
                ...
                <div className="flex items-end">
                  <Button onClick={assignOwnerToDepartment} className="w-full bg-green-600 hover:bg-green-700">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Buat Departemen Baru</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
